...
export function FinanceCommercialPage(){
  ...
  return <div className="commercial-page">
    <DashboardHeader eyebrow="FINANCE · COMMERCIAL CONTROL" title="Commercial Approvals & Project Costs" description="Review BD commercial revisions, approve employee project costs, control vendor/subcontractor liabilities, and monitor project margin without replacing the existing expense-claim or billing lifecycle." actions={<button className="commercial-button secondary" onClick={()=>void loadBase()}><RefreshCcw size={15}/> Refresh</button>} meta={<><span className="nk-meta-chip"><Scale size={14}/> Revisions, employee costs, vendor liability and margin</span><span className="nk-meta-chip"><BadgeIndianRupee size={14}/> INR remains the accounting truth</span><span className="nk-meta-chip"><WalletCards size={14}/> Expense-claim and billing lifecycles unchanged</span></>}/>
